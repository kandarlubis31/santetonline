...
import { BookOpen, Globe, Users, Sparkles, Info } from "lucide-react";
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <motion.div
          ...
          className="bg-secondary/5 dark:bg-secondary/8 border border-secondary/15 dark:border-secondary/20 rounded-2xl p-6 mb-10"
        >
        ...
        <div className="space-y-5">
          ...
          >
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-8 h-8 rounded-lg bg-accent/8 dark:bg-accent/10 flex items-center justify-center">
                <BookOpen className="w-4 h-4 text-accent/70 dark:text-accent/80" />
              </div>
              <h2 className="font-['Cinzel'] text-xl font-bold text-accent">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={i}
                  className="bg-background/50 dark:bg-[#0a0a0f]/40 rounded-xl p-4 border border-border/50 dark:border-border"
                >
                  <h4 className="text-sm font-semibold text-accent/70 dark:text-accent/80 mb-1">
        ...
        <motion.div
          ...
          className="mt-10 bg-background/50 dark:bg-[#0a0a0f]/40 border border-border/50 dark:border-border rounded-2xl p-6"
        >
          ...
          <ul className="space-y-1.5 text-[12px] text-muted-light/50">
            <li>Sejarah santet di era kerajaan Nusantara (Majapahit, Sriwijaya)</li>
            <li>Fenomena santet online viral di Twitter/X (2024)</li>
            <li>Penelitian UGM tentang persepsi masyarakat terhadap santet</li>
            <li>Film &quot;Paket Santet&quot; (2026) - kombinasi mistis dan digital</li>
            <li>Penelitian Unikom tentang praktik santet melalui internet</li>
          </ul>
        </motion.div>
      </div>
    </div>
