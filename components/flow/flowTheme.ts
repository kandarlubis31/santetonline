...
> = {
  santet: {
    backLink: "text-accent/90 hover:text-accent",
    ...
    stepNumber: "bg-accent/8 dark:bg-accent/10 text-accent dark:text-accent/80",
    ...
    refText: "text-accent",
    copyIcon: "text-accent/70",
    copyHover: "hover:bg-accent/10",
    sectionLabel: "text-accent/90",
    trackingActiveIcon: "bg-accent/10 text-accent",
  ...
  ruqiah: {
    ...
    stepNumber: "bg-green/8 dark:bg-green/10 text-green dark:text-green/80",
